...
const UserBookings = () => {
  ...
  return (
    <>
      <Breadcrumbs title="Moje rezerwacje" subtitle="Moje rezerwacje" />
      <DashboardMenu />
                  ...
                  <div className="col-xl-7 col-lg-8 col-sm-12 col-12">
                    <div className="booking-lists">
                      <ul className="nav">
                        ...
                        <li>
                          <Link to={routes.userBookingUpcoming}>Nadchodzące</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to={routes.userBookingComplete}>Zrealizowane</Link>
                        </li>
                        <li>
                ...
                <div className="card-header">
                  <div className="row align-items-center">
                    <div className="col-md-5">
                      <h4>
                        Wszystkie rezerwacje <span>40</span>
                      </h4>
                    </div>
