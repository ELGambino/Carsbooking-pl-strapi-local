...
const UserPayment = () => {
    ...
    return (
      <div className="dropdown dropdown-action">
        ...
        <div className="dropdown-menu dropdown-menu-end">
          ...
          >
            <i className="feather-file-plus me-1"></i> Zobacz fakturę
          </Link>
          <Link
            className="dropdown-item"
            href="javascript:void(0);"
  ...
  return (
    <>
      <Breadcrumbs title="Transakcje" subtitle="Transakcje" />
      <DashboardMenu />
            ...
            <div className="modal-header border-0 m-0 p-0">
              <div className="invoice-btns">
                <Link to="#" className="btn me-2">
                  <i className="feather-printer" /> Print
                </Link>
                <Link to="#" className="btn">
                  <i className="feather-download" /> Download Invoice
                </Link>
              </div>
            </div>
