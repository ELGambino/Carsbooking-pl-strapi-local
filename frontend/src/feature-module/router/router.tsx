...
import { authenticationRoute, blogroutes, listingroutes, pageroutes, publicRoutes, usermodule } from "./router.link";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path={"/react/template"}>
            <Route path="/react/template/index"  element={<Navigate to="/index"/>}  />
        </Route>
      </Routes>
    </>
  );
