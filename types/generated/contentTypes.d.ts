...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Category: Attribute.Enumeration<['Biznes', 'Wynajem']>;
...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    EngineType: Attribute.Enumeration<
    ...
    Gearbox: Attribute.Enumeration<['Automatyczna', 'Manualna']> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    NumberOfDoors: Attribute.Integer &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    YearOfProduction: Attribute.BigInteger &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    EngineCapacity: Attribute.BigInteger &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    AirConditioning: Attribute.Enumeration<['Tak', 'Nie']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Feature: Attribute.Component<'cars.feature', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    Rentals: Attribute.Relation<
      ...
      'api::rental.rental'
    >;
    PickUpPoints: Attribute.Relation<
      'api::car.car',
      'manyToMany',
...
export interface ApiPricePrice extends Schema.CollectionType {
  ...
  attributes: {
    priceName: Attribute.String;
    rentalPrice: Attribute.Integer;
    Cars: Attribute.Relation<'api::price.price', 'manyToMany', 'api::car.car'>;
    Rentals: Attribute.Relation<
      'api::price.price',
      'manyToMany',
      'api::rental.rental'
